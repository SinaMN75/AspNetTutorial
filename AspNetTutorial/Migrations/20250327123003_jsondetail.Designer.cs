...
namespace AspNetTutorial.Migrations
{
    ...
    [Migration("20250327123003_jsondetail")]
    partial class jsondetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AspNetTutorial.Entities.ClassEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AspNetTutorial.Entities.SchoolEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AspNetTutorial.Entities.ClassEntity", b =>
                {
                    b.HasOne("AspNetTutorial.Entities.SchoolEntity", "School")
                        .WithMany("Classes")
            ...
            modelBuilder.Entity("ClassEntityUserEntity", b =>
                {
                    b.HasOne("AspNetTutorial.Entities.ClassEntity", null)
                        .WithMany()
                        .HasForeignKey("ClassesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AspNetTutorial.Entities.UserEntity", null)
                        .WithMany()
